...
const baseClasses = `flex cursor-pointer items-center  justify-center font-medium text-sm gap-2 px-4 py-3 transition-opacity hover:opacity-80 disable:cursor-not-allowed disabled:opacity-80`;
